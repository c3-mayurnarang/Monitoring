...
ENV_NAME="sbox"
CUST_NAME="shell"
SUB_ID="85dbadd9-19ca-4744-a37c-013763b41788"
TENANT_ID="bd3eeefe-e2f5-40d6-abc6-bbb9c8f48d03"
CLIENT_ID="91359085-ac85-45c4-bbd5-8ce0ba05ad84"
CLIENT_SECRET="mI4BzCZOSxAW2IO+gkuiTQ=="
HTACCESS="c3monitoring:\$apr1\$pSyvf/Et\$mE9WblTYHn7TPLazCbTRW/"
# END MANDATORY VARIABLE
# START SCRIPT
PROMETHEUS_FILE=/opt/monitoring/prometheus/current/prometheus.yml
exec > >(tee /var/log/user-data.log|logger -t user-data -s 2>/dev/console) 2>&1
hostname sbox-shell-mon-02.c3-prod.internal
...
#    azure_sd_configs:
#      - environment: AzurePublicCloud #default
